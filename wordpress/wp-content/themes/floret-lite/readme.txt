...
Tags:blog,two-columns,right-sidebar,full-width-template,custom-colors,custom-menu,
...
* Floret Lite WordPress Theme, Copyright 2022 Grace Themes 
* Floret Lite is distributed under the terms of the GNU GPL
...
= 1.1 =
* html5 support function added properly
* Wocommerce sidebar cart related issue fixed.
...
Source: https://www.maxpixel.net/Betals-Buds-Flowers-Flower-Buds-Tulips-5783486 (slider image)
